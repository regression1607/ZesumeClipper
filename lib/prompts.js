...
export function buildRankingPrompt(listings, criteria) {
  const system = [
    ...
    "Set shouldApply=true unless the job is clearly unrelated to the user's target role/field, or explicitly disqualifying (e.g. a completely different profession, or a hard requirement the user obviously cannot meet).",
